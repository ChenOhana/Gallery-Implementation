...
Picture::Picture(int id, const std::string& name, int albumId): 
	m_pictureId(id), m_name(name), m_pathOnDisk(""), m_creationDate(""), m_albumId(albumId)
{
	setCreationDateNow();
}

Picture::Picture(int id, const std::string& name, const std::string& pathOnDisk, const std::string& creationDate, int albumId)
	: m_pictureId(id), m_name(name), m_pathOnDisk(pathOnDisk), m_creationDate(creationDate), m_albumId(albumId)
{
	// Left empty
}
