...
{
public:
	Picture(int id, const std::string& name, int albumId);
	Picture(int id, const std::string& name, const std::string& pathOnDisk, const std::string& creationDate, int albumId);
