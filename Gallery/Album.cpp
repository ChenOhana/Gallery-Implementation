...
Album::Album(int id, int ownerId, const std::string& name) :
	m_albumId(id), m_ownerId(ownerId), m_name(name), m_pictures{}
{
	setCreationDateNow();
}

Album::Album(int id, int ownerId, const std::string& name, const std::string& creationTime) :
	m_albumId(id), m_ownerId(ownerId), m_name(name), m_creationDate(creationTime), m_pictures{}
{
	// Left empty
}
